		...
		usi_app.load = function () {
			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if (usi_cookies.value_exists('stck_unlimited') && !usi_commons.gup_or_get_cookie('usi_skip_unlimited')) {
